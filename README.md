...
| 9 | **Stacked qualifiers and empty emphasis** (*weak alone*) | "could potentially possibly be argued", "genuinely... really...", "The implications are significant" | Keep only qualifiers the source supports; cut intensifiers; name the implication or cut it |
...
| # | Pattern | Before | After |
|---|---------|--------|-------|
| 26 | **Things that act and a narrator at a distance** (*weak alone*) | "The complaint becomes a fix", "What makes this hard is...", "People tend to..." | Name who acted, or write the sentence without an actor; lead with the subject |
...
- **3.1.0** - Added pattern #26 in a new section, F. Hidden actors. It covers inanimate things given human verbs, which hides who acted, and the narrator who reports on people in general or opens on a What or Why clause. Extended §9 to cover stacked intensifiers and sentences that say something matters without saying what. These tells come from a fork's patterns 34-37, folded into the 3.0.0 structure. 26 patterns total.
